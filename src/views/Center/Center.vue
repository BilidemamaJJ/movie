<template>
    <div>
        <div class="main scroll" :style="{height:height + 'px'}">
            <div class="center-view">
                <div class="avatar">
                    <div class="headIconBox">
                        <img v-if="userInfo.userId" :src="userInfo.headIcon" alt="" class="headIcon">
                    ...
                    <div v-if="userInfo.userId" class="nick-name" @click="userDetail()">{{userInfo.mobile}}</div>
                ...
                <div class="margin-set system-set">
                    <img
                        ...
                        alt=""
                    />
                    <!-- <span class="label" @click="gotoSetting()">设置</span> -->
                    <router-link to="/center/setting" tag="span" class="label">设置</router-link>
                    <img
                        src="data:image/png;base64,"
                        alt=""
                        class="arrow"
...
export default {
    ...
    methods: {
        login: function(){
            this.$router.push({path: '/center/login'})
        },
        userDetail: async function(){
            this.$router.push('/center/logout')
        },
        gotoSetting(){
            this.$router.push({path:'/center/setting'})
        }
    },
}
</script>
